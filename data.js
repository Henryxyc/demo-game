...
(function (root) {
  ...
  var BREAK_CHANCE = [
    [40,  22,  10,  5,   2.5, 1.5, 1.5, 1.5, 1.5, 2,   1.5, 1.5],  /* 天赋1(F) */
    [60,  35,  16,  7,   3.5, 2,   1.5, 1.5, 1.5, 2.5, 2,   1.5],  /* 天赋2(E) */
    [80,  50,  26,  12,  6,   3,   2,   2,   2,   3,   2.5, 2],    /* 天赋3(D) */
    [100, 72,  45,  24,  12,  6,   3,   2.5, 2.5, 3.5, 2.5, 2],  /* 天赋4(C) */
    [120, 95,  68,  42,  22,  11,  5.5, 4,   3.5, 4.5, 3.5, 2.5],  /* 天赋5(B) */
    [140, 115, 92,  65,  38,  20,  10,  7,   5,   6,   4.5, 3.5],  /* 天赋6(A) */
    [165, 135, 108, 85,  55,  32,  16,  10,  6,   7,   5,   3.5],  /* 天赋7(S) */
    [200, 165, 132, 108, 75,  48,  25,  13,  7,   8,   6,   4.5],  /* 天赋8(SS) */
    [250, 205, 170, 140, 110, 75,  40,  20,  10,  11,  8,   5.5],  /* 天赋9(SSS) */
    [310, 265, 220, 180, 145, 105, 55,  32,  15,  12,  9,   6.5]   /* 天赋10(EX) */
  ];
  ...
  var ESSENCE = [
    { id: 'essence1',   name: '基因源质·赤情之心', needCombat: 80000, rate: 1.24 },
    { id: 'essence2',  name: '基因源质·锋锐之金',   needCombat: 90000, rate: 1.33 },
    { id: 'essence3',  name: '基因源质·生机之木', needCombat: 100000, rate: 1.42 },
    { id: 'essence4',   name: '基因源质·无垠之渊',   needCombat: 110000, rate: 1.51 },
    { id: 'essence5',  name: '基因源质·不灭之焰',   needCombat: 120000, rate: 1.6 },
    { id: 'essence6',  name: '基因源质·厚土之核', needCombat: 130000, rate: 1.69 },
    { id: 'essence7',   name: '基因源质·双生之涡', needCombat: 410000, rate: 1.78 },
    { id: 'essence8',   name: '基因源质·星渊之枢', needCombat: 140000, rate: 1.87 },
    { id: 'essence9',  name: '基因源质·命轮之弦', needCombat: 435000, rate: 1.96 },
    { id: 'essence10',   name: '基因源质·太初之光', needCombat: 150000, rate: 2.05 }
  ];
  ...
  var DATA = {
    ...
    GUARD: GUARD,
    guardInfo: guardInfo,
    /* 基础寿命：以异能天赋 X 计，实际寿命区间 = (LIFE_MIN+X, LIFE_MAX+X) */
